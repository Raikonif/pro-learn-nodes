# TDD Workflow Conventions

## Purpose

Define the cross-cutting testing discipline both sides of the codebase follow: when test files are created, how they are named, and which suites gate a merge.
