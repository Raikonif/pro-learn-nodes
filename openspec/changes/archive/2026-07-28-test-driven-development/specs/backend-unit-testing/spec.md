...
> A test-database fixture is NOT part of this change: no database exists in the project yet. It is introduced by the phase that adds the data model and migrations, at which point this requirement is extended.
