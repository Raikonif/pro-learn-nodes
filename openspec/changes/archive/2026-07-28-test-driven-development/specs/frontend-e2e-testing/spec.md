...
> Coverage of the graph canvas (spatial view) rendering without console errors is NOT part of this change — no graph canvas exists yet. It is added by the phase that introduces the graph view.
